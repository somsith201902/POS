...
## Row1
L1 = Label(GUI, text='Product', font=font_title)
...
## Row2
L2 = Label(GUI, text='Price', font=font_title)
...
## Row3
L3 = Label(GUI, text='Amount', font=font_title)
L3.pack(pady=10) # for c center aglin

v_amount = StringVar() #box3

B3 = Entry(GUI, textvariable=v_amount) 
B3.pack()
...
But_1 = Button(GUI, text='calculate',command=Calc)
...
R1 = Label(GUI, textvariable=v_result,font=font_result) 
R1.pack()
